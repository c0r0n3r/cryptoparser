...
from cryptoparser.ike.version import IsakmpProtocolVersion, IsakmpVersionFactory


class TestIsakmpProtocolVersion(unittest.TestCase):
    def setUp(self):
        self.version_bytes = b'\x11'
        self.version = IsakmpProtocolVersion(IkeVersion.V1, 1)
    ...
    def test_parse(self):
        ...
        self.assertEqual(version.major, IkeVersion.V1)
    ...
    def test_ordering(self):
        ...
        self.assertLess(version_1_1, version_2_0)
        self.assertEqual(sorted([version_2_0, version_1_1, version_1_0]),
                         [version_1_0, version_1_1, version_2_0])


class TestIsakmpVersionFactory(unittest.TestCase):
    def test_get_enum_class(self):
        self.assertEqual(IsakmpVersionFactory.get_enum_class(), IkeVersion)
