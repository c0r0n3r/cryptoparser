...
class VectorString(VectorBase):
    ...
    def _parse(cls, parsable):
        ...
        body_parser = ParserText(parsable[vector_param.item_num_size:header_parser['item_byte_num'] + vector_param.item_num_size])
    ...
    def compose(self):
        ...
        body_composer.compose_string(vector_param.separator.join(map(lambda item: item.value.code, self._items)))
