...
from cryptoparser.ssh.ciphersuite import SshEncryptionAlgorithms, SshMacAlgorithms, SshKexAlgorithms
from cryptoparser.ssh.ciphersuite import SshHostKeyAlgorithms, SshHostKeyType, SshCompressionAlgorithms
from cryptoparser.ssh.ciphersuite import SshHostKeyAlgorithmFactory
...
class SshKeyExchangeInit(SshMessageBase):
    ...
    def compose(self):
        ...
        for param_name in self._PARSABLES:
...
class SshHostKey(JSONSerializable, ParsableBase):
    ...
    def as_json(self):
        if isinstance(self.host_public_key, x25519.X25519PublicKey):
            ...
            host_key_openssh = str(self.host_public_key.public_bytes(
                Encoding.OpenSSH,
