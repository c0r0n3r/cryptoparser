...
class TestHandshakeClientHello(unittest.TestCase):
    def setUp(self):
...
class TestHandshakeServerHello(unittest.TestCase):
    def setUp(self):
...
class TestHandshakeCertificate(unittest.TestCase):
    def setUp(self):
...
class TestHandshakeServerHelloDone(unittest.TestCase):
    def setUp(self):
