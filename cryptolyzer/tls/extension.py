...
from cryptolyzer.common.base import Vector, VectorParsable, VectorParsableDerived, VectorParamNumeric, VectorParamParsable
from cryptolyzer.common.algorithm import Authentication, MAC
from cryptolyzer.common.base import TwoByteEnumComposer, TwoByteEnumParsable
from cryptolyzer.common.exception import NotEnoughData, InvalidValue
from cryptolyzer.common.parse import ParsableBase, ParserBinary, ComposerBinary
from cryptolyzer.tls.version import TlsProtocolVersionBase
...
class TlsExtensionType(enum.IntEnum):
    ...
    KEY_SHARE = 0x0028                               # [DRAFT-IETF-TLS-TLS13-20]
